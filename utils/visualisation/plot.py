...
def save_results(rgb_img, grasp_q_img, grasp_angle_img, depth_img=None, no_grasps=1, grasp_width_img=None, index = 0):
    """
    Plot the output of a network
    :param rgb_img: RGB Image
    :param depth_img: Depth Image
    ...
    ax.set_title('RGB')
    ax.axis('off')
    os.makedirs(f'results/image_{index}', exist_ok=True)
    fig.savefig(f'results/image_{index}/rgb.png')
    ...
    if depth_img is not None:
        if depth_img.any():
            ...
            ax.set_title('Depth')
            ax.axis('off')
            fig.savefig(f'results/image_{index}/depth.png')
    ...
    ax.set_title('Grasp')
    ax.axis('off')
    fig.savefig(f'results/image_{index}/grasp.png')
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig(f'results/image_{index}/quality.png')
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig(f'results/image_{index}/angle.png')
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig(f'results/image_{index}/width.png')
